...
const plans = [
  {
    ...
    popular: false,
    features: [
      "Signup limit: 15,000 users",
      "Create up to 3 waitlists",
      "Create up to 3 landing pages",
      "Email up to 2,000 users each month",
      "Use 10 email templates",
      "Custom email creation",
      "One domain for branded emails and landing pages",
  ...
  },
  {
    ...
    popular: true,
    features: [
      "Signup limit: 75,000 users",
      "Create up to 15 waitlists",
      "Create up to 15 landing pages",
      "Email up to 30,000 users each month",
      "Create 30 email templates",
      "Custom email creation",
      "Up to 10 domains for emails and landing pages",
  ...
  },
  {
    ...
    popular: false,
    features: [
      "Signup limit: 500,000 users per month",
      "Create up to 100 waitlists",
      "Create up to 100 landing pages",
      "Configure 200 email templates",
      "Email up to 100,000 users each month",
      "Configure 500 domains for emails and landing pages",
      "Extra security to block fake or disposable emails",
      "Analytics for sent emails and registered users",
